    ...
    <div class="offset-md-2 col-md-8">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" id="teacher_name" name="teacher_name" placeholder="Enter Teacher Name">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="teacher_qualification">Teacher Qualification :</label>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="number" id="teacher_qualification" name="teacher_qualification" placeholder="Enter Teacher Qualification">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-sm-4 col-lg-3 d-none d-sm-block" for="teacher_experience">Teacher Experience :</label>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" id="teacher_experience" name="teacher_experience" placeholder="Enter Teacher Experience">
                </div>
            </div>
            <div class="form-group row">
